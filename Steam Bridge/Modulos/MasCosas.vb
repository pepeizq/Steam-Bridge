...
Module MasCosas
    ...
    Dim traduccion As String = "https://poeditor.com/join/project/UYVDZ4FYAt"
    Dim codigoFuente As String = "https://github.com/pepeizq/Steam-Bridge"
    Dim gridPrincipalNombre As String = "gridBridge"
