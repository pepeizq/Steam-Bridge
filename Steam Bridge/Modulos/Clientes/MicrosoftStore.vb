...
Module MicrosoftStore
    ...
    Public Async Sub Generar2(pb As ProgressBar, lv As ListView)
        ...
        Dim paquetesManager As New PackageManager
        Dim paquetes As IEnumerable(Of Package) = paquetesManager.FindPackagesForUser("")

        For Each paquete In paquetes
            Dim carpeta As StorageFolder = Nothing

            Try
                carpeta = paquete.InstalledLocation
            Catch ex As Exception

            End Try

            If Not carpeta Is Nothing Then
                Dim manifiesto As StorageFile = Await carpeta.GetFileAsync("AppxManifest.xml")
                    ...
                    If Not lineas = Nothing Then
                        If lineas.Contains("<Application Id=") Then
                            ...
                            If lineas.Contains("<Identity Name=") Then
                                ...
                                Dim int7 As Integer = carpeta.Path.LastIndexOf("\")
                                Dim paqueteString As String = carpeta.Path.Remove(0, int7 + 1)

                                If paqueteString.Contains("_") Then
                                    Dim int11 As Integer = paqueteString.IndexOf("_")
                                    Dim int12 As Integer = paqueteString.LastIndexOf("_")

                                    paqueteString = paqueteString.Remove(int11, int12 - int11)
                                End If
                                ...
                                If Not nombre.Contains("ms-resource:") Then
                                    ...
                                    Try
                                        icono = Await SacarImagen(lineas, carpeta.Path)
                                    Catch ex As Exception
                                    ...
                                    If tituloBool = False Then
                                        Dim juego As New Juego(nombre, "shell:AppsFolder\" + paqueteString + "!" + id, Nothing, icono, colorFondo, False, "Microsoft Store")
